...
def killJVM(host, username, passwd, getJavaPid, checkJVM):
    try:
...
if __name__ == '__main__':
    ...
    checkJVM = ['ps -ef|grep java|grep -v grep|grep ActiveNetCUI']  # 检查JVM状态
    ...
    for i in range(1, 9):
        ...
        a = threading.Thread(target=killJVM, args=(host1, username, passwd, getJavaPid, checkJVM))
        a.start()
