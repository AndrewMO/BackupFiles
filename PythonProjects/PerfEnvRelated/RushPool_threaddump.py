...
def threaddump(host, username, passwd, getJavaPid, JavaHome, threadfilepath):
    try:
        ...
        threaddumpcmd = []
        threaddumpcmd.append('cd ' + JavaHome +';'+'./jstack -l ' + JavaPid + ' >' + threadfilepath + '/enrollmentredesign_03_servlet_' + ServerNo +'w_threaddump.txt' )
...
if __name__ == '__main__':
    ...
    threadfilepath = "/opt/active/ActiveNet/perf/enrollmentredesign/servlet" #dump文件存放路径
