...
if __name__ == '__main__':
    ...
    local_servlet_dumpfile_location = '/Users/ajia/Documents/tmp/enrollmentredesigndumps/'
    remote_servlet_dumpfile_location = '/opt/active/ActiveNet/perf/enrollmentredesign/servlet'


    local_newcui_dumpfile_location = '/Users/ajia/Documents/tmp/enrollmentredesigndumps/'
    remote_newcui_dumpfile_location = '/opt/active/ActiveNet/perf/enrollmentredesign/newcui'
    ...
    for i in range(1, 2):
        ...
        download(host, username, passwd, local_servlet_dumpfile_location, remote_servlet_dumpfile_location, 2)
        download(host, username, passwd, local_newcui_dumpfile_location, remote_newcui_dumpfile_location, 2)
